...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " GLOBE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " GLOBE" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " GLOBE");
    }
