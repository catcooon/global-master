...
static const int64_t COIN_YEAR_REWARD = 6 * CENT; //(output to console will be updated)
...
public:
    ...
    {
        // global: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // global: get transaction coin age
...
public:
    ...
    // global: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // global: two types of block: proof-of-work or proof-of-stake
    ...
    // global: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // global: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // global: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // global: block index flags
    enum  
    {
